    ...
    def run(self):
        ...
        while abs(position_x) > 0.05 or abs(position_y) > 0.05:
            ...
            if bbox:
                ...
                center_rov(move = self._control,Bbox = bbox, depth_sensor = self.depth_sensor, environment=self.environment,logger = self._logger)
